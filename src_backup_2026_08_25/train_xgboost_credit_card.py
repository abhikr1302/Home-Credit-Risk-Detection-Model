...
DATA_PATH = Path(
    "data/processed/model_features_credit_card_train.parquet"
)
...
def main() -> None:
    ...
    print(
        ...
        "Installments + Credit Card features..."
    )
    ...
    print("\nCredit Card XGBoost Metrics:")
    print(json.dumps(metrics, indent=4))

    metrics_path = (
        REPORT_DIRECTORY
        / "xgboost_credit_card_metrics.json"
    )
    ...
    model_path = (
        MODEL_DIRECTORY
        / "xgboost_credit_card_model.joblib"
    )
    ...
    validation_predictions_df.to_csv(
        REPORT_DIRECTORY
        / "xgboost_credit_card_validation_predictions.csv",
        index=False,
    )

    print("\n✓ Credit Card XGBoost training complete")
