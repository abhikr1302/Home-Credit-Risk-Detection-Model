...
DATA_PATH = Path(
    "data/processed/model_features_repayment_train.parquet"
)
...
def main() -> None:
    ...
    print("\nRepayment XGBoost Metrics:")
    print(json.dumps(metrics, indent=4))

    metrics_path = (
        REPORT_DIRECTORY
        / "xgboost_repayment_metrics.json"
    )
    ...
    model_path = (
        MODEL_DIRECTORY
        / "xgboost_repayment_model.joblib"
    )
    ...
    validation_predictions_df.to_csv(
        REPORT_DIRECTORY
        / "xgboost_repayment_validation_predictions.csv",
        index=False,
    )

    print("\n✓ Repayment XGBoost training complete")
